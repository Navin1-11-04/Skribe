  ...
  return (
    <div className="text-sm pb-2">
      ...
      <div className="mt-0 pb-0 px-1">
        ...
        <div className="mt-1 w-full max-h-[calc(100vh-17.5vh)] overflow-y-auto pl-2 pr-1 py-0.5">
          {filterDocuments?.map((document) => (
            <div
              key={document._id}
              role="button"
              onClick={() => onClick(document._id)}
              className="text-sm rounded-sm w-full flex items-center text-primary justify-between p-1 pl-2 cursor-default 
              hover:bg-sidebar-ring/15"
            >
              ...
              <div className="flex items-center gap-0">
                <div
                  ...
                  role="button"
                  className="hover:bg-sidebar-ring/30 p-1.5 rounded-sm"
                >
                  <RotateCcw
